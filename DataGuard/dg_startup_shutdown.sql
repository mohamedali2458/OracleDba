...
We will look at Oracle Data Guard startup and shutdown sequence. You must follow proper shutdown order to perform a graceful shutdown.

Make sure you have permission from application owner / database architect to perform primary shutdown.
