...
PROMPT Retrieving the Biggest 100 Objects: [Desc Order]
PROMPT ----------------------------------


Select * from (select /*+RULE*/ OWNER,SEGMENT_NAME,SEGMENT_TYPE,TABLESPACE_NAME,BYTES/1024/1024 SIZE_MB from dba_segments order by 5 desc)where rownum <101 order by 5; 
EOF
