...
ASM Metadata allows you to manage ASM disks and Diskgroups smoothly. The fastest way to administer 
ASM is via sqlplus / as sysasm. Here are some of my favorite ASM queries that will help you 
...
There are two important columns under V$ASM_DISK which are MOUNT_STATUS and HEADER_STATUS. 
...
CACHED – Disk is present in the storage system, and is part of a disk group being 
         ccessed by the ASM instance. This is the normal state for disks in an ASM.
